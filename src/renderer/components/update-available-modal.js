  ...
  render () {
    ...
    return (
      <div className='update-available-modal'>
        <p><strong>A new version of WebContent is available: v{state.modal.version}</strong></p>
        <p>
    ...
    function handleShow () {
      ...
      electron.shell.openExternal('https://github.com/webcontent/webcontent-desktop/releases')
      dispatch('exitModal')
    }
